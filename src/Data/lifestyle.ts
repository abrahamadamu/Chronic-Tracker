...
const LifestyleChanges: CodeTextPair[] = [
  ...
  { code: "LIFS_CH_5", text: "Medication Side Effects" },
  { code: "LIFS_CH_6", text: "Daily Foot Inspection" },
  { code: "LIFS_CH_7", text: "Family Screening" },
  { code: "LIFS_CH_8", text: "Injection Techniques" },
];
